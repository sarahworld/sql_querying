...
INSERT INTO products (name,price,can_be_returned) VALUES ('ottomon',500.00,false); 

--8. Display only the products that can_be_returned
SELECT * FROM products AS p WHERE p.can_be_returned = true;

--9. Display only the products that have a price less than 44.00.
SELECT * FROM products AS p WHERE p.price < 44;

--10. Display only the products that have a price in between 22.50 and 99.99.
SELECT * FROM products AS p WHERE p.price < 99.99 AND p.price > 22.50;
